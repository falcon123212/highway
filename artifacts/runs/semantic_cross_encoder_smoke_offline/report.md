...
|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 80 | ooc_full_scan | 20 | 0 | 0/0 | 100.00% | 100.00% | 6.49 ms | 80.00 | 0.00 ms | 0.00% | 50.00 | 100.00% |
| 80 | ooc_semantic_cross_encoder_rescue | 20 | 40 | 40/20 | 100.00% | 100.00% | 559.41 ms | 50.00 | 536.50 ms | 100.00% | 50.00 | 100.00% |

## Best Compromises

| Size | Best recall | Best latency | Best recall <100ms | Best recall <200ms | Best tradeoff |
|---:|---|---|---|---|---|
| 80 | ooc_full_scan cap 20 lex 0 (100.00%) | ooc_full_scan cap 20 lex 0 (6.49 ms) | ooc_full_scan cap 20 lex 0 (100.00%, 6.49 ms) | ooc_full_scan cap 20 lex 0 (100.00%, 6.49 ms) | ooc_full_scan cap 20 lex 0 (100.00%, 6.49 ms) |
...
Metrics JSON: `artifacts/runs/semantic_cross_encoder_smoke_offline/metrics.json`
Records JSONL: `artifacts/runs/semantic_cross_encoder_smoke_offline/records.jsonl`
